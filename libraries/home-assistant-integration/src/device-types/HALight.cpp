...
const char* HALight::PercentageCommandTopic = {"sct"};
const char* HALight::PercentageStateTopic = {"sst"};
...
// HALight::HALight(const char* uniqueId, uint8_t features, HAMqtt& mqtt) :
//     HALight(uniqueId, features)
// {
//     (void)mqtt;
// }
